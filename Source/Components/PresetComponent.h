...
private:
    ...
    PluginAudioProcessor& audioProcessor; // 添加对 PluginAudioProcessor 的引用
    PluginPresetManager& presetManager;
    juce::UndoManager& undoManager;
    juce::TextButton undoButton, redoButton, saveButton, deleteButton, previousPresetButton, nextPresetButton, resetButton;
